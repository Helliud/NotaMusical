    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                if (frecuenciaFundamental >= 107.00 && frecuenciaFundamental <= 113.00)
                {
                    lblNota.Text = "A great";
                }

                if (frecuenciaFundamental >= 143.83 && frecuenciaFundamental <= 149.83)
                {
                    lblNota.Text = "D small";
                }

                if (frecuenciaFundamental >= 161.81 && frecuenciaFundamental <= 167.88)
                {
                    lblNota.Text = "E small";
                }

                if (frecuenciaFundamental >= 171.61 && frecuenciaFundamental <= 177.61)
                {
                    lblNota.Text = "F small";
                }
                ...
                if (frecuenciaFundamental >= 217.00 && frecuenciaFundamental <= 220.00)
                {
